...
<div class="uk-width-medium-1-1">
	<div class="uk-width-medium-9-10 goods-medium">
   		<div class="uk-form-controls">
	        ...
	        <label><input type="radio" name="goodsStatus" value="1" checked> 未审核</label>
	        <label><input type="radio" name="goodsStatus" value="0"> 已通过</label>
	        <label><input type="radio" name="goodsStatus" value="2"> 未通过</label>	       
	    </div>
	    <hr />
